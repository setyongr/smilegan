...
def get_test_input(test_dir):
    ...
    return neutral_test_ds, smile_test_ds


def get_input(data_dir, test_dir):
    train_input = get_train_input(data_dir)
    test_input = get_test_input(test_dir)
